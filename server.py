...
class ServerGUI:
    ...
    def handle_client(self, client_socket):
        ...
        # Remove the client socket when the client disconnects
    ...
    def get_key(self):
        ...
        label = tk.Label(top, text="Enter the 16-Bit AES key:", bg="#808080", fg="white")  # Set gray background and white text
        label.pack(pady=10)  
